            ...
            <span
              ...
              dangerouslySetInnerHTML={{
                __html: translate({
                  ...
                  message:
                    'inoERP is an  <b><a href ="http://docs.rikdata.com">OneApp</a></b> [ <i>Go back-end & Flutter front-end</i> ] based enterprise management system',
                  description:
                    "inoERP is an OneApp (GoLang back-end & Flutter front-end) based enterprise management system",
                }),
              }}
            />
          </h1>
            ...
            values={{
              migrationGuideLink: (
                <Link to="http://docs.rikdata.com">
                  <Translate>
                    checkout how to use OneApp for all business systems
                  </Translate>
                </Link>
              ),
            }}
