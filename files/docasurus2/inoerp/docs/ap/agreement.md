...
|**110**|*vvTaxCalculationMethod*| Tax Calculation Method |defferedSelect|FINANCE|
|**120**|*vvTaxPercentage*| Tax Percentage |defferedSelect|FINANCE|
|**130**|*vvTaxTaxAmount*| Tax Tax Amount |InputType.textField|FINANCE|
|**140**|*vvDiscountName*| Discount Name |defferedSelect|FINANCE|
|**150**|*vvDiscountPercentage*| Discount Percentage |defferedSelect|FINANCE|
...
|**270**|*taxCode*|Tax Code |defferedSelect|FINANCE|
...
|**440**|*discountCode*|Discount Code |defferedSelect|FINANCE|
|**450**|*approvalStatus*|Approval Status |InputType.select|CONTROL|
|**500**|*invApTransactionLineId*|Inv Ap Transaction Line Id |defferedSelect|REFERENCE|
