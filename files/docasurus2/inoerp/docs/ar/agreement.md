...
|**270**|*buOrgId*|Bu Org Id |defferedSelect|REFERENCE|
...
|**310**|*arCustomerId*|Ar Customer Id |defferedSelect|REFERENCE|
|**320**|*arCustomerSiteId*|Ar Customer Site Id |defferedSelect|REFERENCE|
|**330**|*hrEmployeeId*|Hr Employee Id |InputType.number|REFERENCE|
|**340**|*description*|Description |InputType.textField|DEFAULT|
|**350**|*shipToId*|Ship To Id |defferedSelect|REFERENCE|
|**360**|*billToId*|Bill To Id |defferedSelect|PLANNING|
|**370**|*priceListHeaderId*|Price List Header Id |InputType.number|REFERENCE|
|**380**|*docCurrency*|Doc Currency |defferedSelect|FINANCE|
|**390**|*paymentTermId*|Payment Term Id |defferedSelect|REFERENCE|
|**400**|*paymentTermDate*|Payment Term Date |InputType.date|DATE|
|**410**|*exchangeRateType*|Exchange Rate Type |defferedSelect|CONTROL|
...
|**570**|*glAcProfileHeaderId*|Gl Ac Profile Header Id |defferedSelect|REFERENCE|
...
|**30**|*vvDocCurrency*| Doc Currency |defferedSelect|FINANCE|
|**40**|*vvExchangeRate*| Exchange Rate |InputType.textField|FINANCE|
|**50**|*vvExchangeRateType*| Exchange Rate Type |defferedSelect|CONTROL|
|**60**|*vvBuOrgId*| Bu Org Id |defferedSelect|REFERENCE|
|**70**|*vvUomCode*| Uom Code |defferedSelect|DEFAULT|
|**80**|*vvUomDescription*| Uom Description |defferedSelect|DEFAULT|
|**90**|*vvItemStatus*| Item Status |defferedSelect|CONTROL|
|**100**|*vvShipToAddressName*| Ship To Address Name |defferedSelect|ENTITY|
|**110**|*vvShipToAddress*| Ship To Address |defferedSelect|ENTITY|
|**120**|*vvShipToCountry*| Ship To Country |defferedSelect|ENTITY|
|**130**|*vvShipToPostalCode*| Ship To Postal Code |defferedSelect|ENTITY|
|**140**|*vvShipToEmail*| Ship To Email |defferedSelect|ENTITY|
|**150**|*vvShipToPhone*| Ship To Phone |defferedSelect|ENTITY|
|**160**|*vvBillToAddressName*| Bill To Address Name |defferedSelect|PLANNING|
|**170**|*vvBillToAddress*| Bill To Address |defferedSelect|PLANNING|
|**180**|*vvBillToCountry*| Bill To Country |defferedSelect|PLANNING|
|**190**|*vvBillToPostalCode*| Bill To Postal Code |defferedSelect|PLANNING|
|**200**|*vvBillToEmail*| Bill To Email |defferedSelect|PLANNING|
|**210**|*vvBillToPhone*| Bill To Phone |defferedSelect|PLANNING|
|**220**|*vvDiscountedLinePrice*| Discounted Line Price |InputType.textField|FINANCE|
|**230**|*vvTaxCalculationMethod*| Tax Calculation Method |defferedSelect|FINANCE|
|**240**|*vvTaxPercentage*| Tax Percentage |defferedSelect|FINANCE|
|**250**|*vvTaxTaxAmount*| Tax Tax Amount |InputType.textField|FINANCE|
|**260**|*vvDiscountName*| Discount Name |defferedSelect|FINANCE|
|**270**|*vvDiscountPercentage*| Discount Percentage |defferedSelect|FINANCE|
...
|**300**|*srcEntityName*|Src Entity Name |defferedSelect|DEFAULT|
...
|**350**|*itemDescription*|Item Description |defferedSelect|DEFAULT|
...
|**440**|*taxCode*|Tax Code |defferedSelect|FINANCE|
...
|**520**|*discountCode*|Discount Code |defferedSelect|FINANCE|
|**530**|*lineDiscountAmount*|Line Discount Amount |InputType.textField|FINANCE|
|**580**|*shipToId*|Ship To Id |defferedSelect|REFERENCE|
|**590**|*billToId*|Bill To Id |defferedSelect|PLANNING|
