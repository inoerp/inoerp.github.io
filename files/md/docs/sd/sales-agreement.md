...
|**250**|*buOrgId*|Bu Org Id |deferredSelect|REFERENCE|
...
|**130**|*vvBillToAddressName*| Bill To Address Name |deferredSelect|PLANNING|
|**140**|*vvBillToAddress*| Bill To Address |deferredSelect|PLANNING|
|**150**|*vvBillToCountry*| Bill To Country |deferredSelect|PLANNING|
|**160**|*vvBillToPostalCode*| Bill To Postal Code |deferredSelect|PLANNING|
|**170**|*vvBillToEmail*| Bill To Email |deferredSelect|PLANNING|
|**180**|*vvBillToPhone*| Bill To Phone |deferredSelect|PLANNING|
|**190**|*vvDiscountedLinePrice*| Discounted Line Price |InputType.textField|FINANCE|
|**200**|*vvDiscountName*| Discount Name |deferredSelect|FINANCE|
|**210**|*vvDiscountPercentage*| Discount Percentage |deferredSelect|FINANCE|
...
|**280**|*invOrgId*|Inv Org Id |deferredSelect|REFERENCE|
|**290**|*invItemMasterId*|Inv Item Master Id |deferredSelect|REFERENCE|
|**300**|*itemDescription*|Item Description |deferredSelect|DEFAULT|
...
|**460**|*soDocumentTypeLine*|So Document Type Line |deferredSelect|CONTROL|
...
|**530**|*discountCode*|Discount Code |deferredSelect|FINANCE|
|**540**|*lineDiscountAmount*|Line Discount Amount |InputType.textField|FINANCE|
|**550**|*shipToId*|Ship To Id |deferredSelect|REFERENCE|
|**560**|*billToId*|Bill To Id |deferredSelect|PLANNING|
